...
export default {
  ...
  computed: {
    handValid: function() {
      return this.inputIsValid(this.hand.trim(), "hand");
    },
    boardValid: function() {
      return this.inputIsValid(this.board.trim(), "board");
    },
    concatCards: function() {
      const hand = this.inputSplitted(this.hand.trim());
      const board = this.inputSplitted(this.board.trim());
